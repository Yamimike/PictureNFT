...
module picture::royalty_rule {
    ...
    public fun add(
        policy: &mut TransferPolicy<Picture>,
        cap: &TransferPolicyCap<Picture>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<Picture>,
        request: &mut TransferRequest<Picture>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<Picture>, paid: u64): u64 {
